@extends('layouts.app')
@section('title', 'Management Settings — Recommendation')
...
<div class="mgmt-page">
    ...
    <div class="sub-tab-bar">
        ...
        <a href="{{ route('settings.recommendation') }}"  class="sub-tab-btn active">Recommendation</a>
    ...
    <div class="mgmt-card">
        <div class="ch">
            <div>
                ...
                <p class="cd">Manage recommendation options for the leave form</p>
            </div>
        ...
        <div class="tsa">
            <table class="dt">
                ...
                <tbody id="tbody">
                    ...
                    @empty
                    <tr><td colspan="3" style="padding:48px;text-align:center;color:#9ca3af;font-size:13px;">No recommendation options yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
...
<div id="fo" class="ov" onclick="if(event.target===this)closeForm()">
    <div class="mc">
        <h3 class="mt" id="mT">Add Recommendation Option</h3>
